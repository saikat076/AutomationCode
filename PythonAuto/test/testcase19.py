...
@Then("I go to notifications network and validate interactions")
def I_go_to_notifications_network_and_validate_interactions():
    go_to_network_and_validate_interactions()
...
try:
    ...
    I_go_to_notifications_network_and_validate_interactions()
